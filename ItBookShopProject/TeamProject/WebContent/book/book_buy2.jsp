...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Bootshop online 구매하기</title>
...
function couponDis(finalPrice){
	...
	//couponList를 두번 반복하는 이유, 선택된 쿠폰id값 (#1)의 volume(쿠폰금액)을 가져오기위함
		...
		<table class="table table-bordered">
		 ...
		 <td>
		   <div class="control-group">
			 ...
			 <div class="controls">
			   <input type="text" name="totalPrice" id="totalPrice" value="${totalPrice-shipPrice}" readonly="readonly">
			 </div>
		   </div>
		   <div class="control-group">
